...
public class VentaFormController extends FormController<Producto> {
	...
	public void agregarValoresAdicionales(ModelMap map) {
		...
		map.addAttribute("familiaList", getDao().findEntities(true,-1,-1, "Familia"));
